...
def test_class_construction(test_design3):
    """Test the construction of Design2 by checking the levels."""
    test_design3.test_get_unique_levels()
...
def test_anova_calculations(test_design3):
    ...
    """
    test_design3.test__calculate_degrees_of_freedom()
    test_design3.test__calculate_t_values()
    test_design3.test__calculate_sums_of_squares()
    test_design3.test__calculate_mean_squares()
    test_design3.test__calculate_variance()
    test_design3.test_calculate_anova()

def test_g_coefficients(test_design3):
    """Tests the calculation of G coefficients."""
    test_design3.test__calculate_g_coeffs()